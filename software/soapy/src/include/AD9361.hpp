...
#define AD9361_REG_SPI_CONF                               0x000 /* SPI Configuration */
#define AD9361_REG_MULTICHIP_SYNC_AND_TX_MON_CTRL         0x001 /* Multi-Chip Sync and TX Mon Control */
#define AD9361_REG_TX_ENABLE_FILTER_CTRL                  0x002 /* TX Enable & Filter Control */
#define AD9361_REG_RX_ENABLE_FILTER_CTRL                  0x003 /* RX Enable & Filter Control */
#define AD9361_REG_INPUT_SELECT                           0x004 /* Input Select */
#define AD9361_REG_RFPLL_DIVIDERS                         0x005 /* RFPLL Dividers */
#define AD9361_REG_RX_CLOCK_DATA_DELAY                    0x006 /* RX Clock & Data  Delay */
#define AD9361_REG_TX_CLOCK_DATA_DELAY                    0x007 /* TX Clock & Data Delay */
#define AD9361_REG_CLOCK_ENABLE                           0x009 /* Clock Enable */
#define AD9361_REG_BBPLL                                  0x00A /* BBPLL */
#define AD9361_REG_TEMP_OFFSET                            0x00B /* Offset */
#define AD9361_REG_START_TEMP_READING                     0x00C /* Start Temp Reading */
#define AD9361_REG_TEMP_SENSE2                            0x00D /* Temp Sense2 */
#define AD9361_REG_TEMPERATURE                            0x00E /* Temperature */
#define AD9361_REG_TEMP_SENSOR_CONFIG                     0x00F /* Temp Sensor Config */
#define AD9361_REG_PARALLEL_PORT_CONF_1                   0x010 /* Parallel Port Configuration 1 */
#define AD9361_REG_PARALLEL_PORT_CONF_2                   0x011 /* Parallel Port Configuration 2 */
#define AD9361_REG_PARALLEL_PORT_CONF_3                   0x012 /* Parallel Port Configuration 3 */
#define AD9361_REG_ENSM_MODE                              0x013 /* ENSM Mode */
#define AD9361_REG_ENSM_CONFIG_1                          0x014 /* ENSM Config 1 */
#define AD9361_REG_ENSM_CONFIG_2                          0x015 /* ENSM Config 2 */
#define AD9361_REG_CALIBRATION_CTRL                       0x016 /* Calibration Control */
#define AD9361_REG_STATE                                  0x017 /* State */
#define AD9361_REG_AUXDAC_1_WORD                          0x018 /* AuxDAC 1 Word */
#define AD9361_REG_AUXDAC_2_WORD                          0x019 /* AuxDAC 2 Word */
#define AD9361_REG_AUXDAC_1_CONFIG                        0x01A /* AuxDAC 1 Config */
#define AD9361_REG_AUXDAC_2_CONFIG                        0x01B /* AuxDAC 2 Config */
#define AD9361_REG_AUXADC_CLOCK_DIVIDER                   0x01C /* AuxADC Clock Divider */
#define AD9361_REG_AUXADC_CONFIG                          0x01D /* Aux ADC Config */
#define AD9361_REG_AUXADC_WORD_MSB                        0x01E /* AuxADC Word MSB */
#define AD9361_REG_AUXADC_LSB                             0x01F /* AuxADC LSB */
#define AD9361_REG_AUTO_GPO                               0x020 /* Auto GPO */
#define AD9361_REG_AGC_GAIN_LOCK_DELAY                    0x021 /* AGC Gain Lock Delay */
#define AD9361_REG_AGC_ATTACK_DELAY                       0x022 /* AGC Attack Delay */
#define AD9361_REG_AUXDAC_ENABLE_CTRL                     0x023 /* AuxDAC Enable Control */
#define AD9361_REG_RX_LOAD_SYNTH_DELAY                    0x024 /* RX Load Synth Delay */
#define AD9361_REG_TX_LOAD_SYNTH_DELAY                    0x025 /* TX Load Synth Delay */
#define AD9361_REG_EXTERNAL_LNA_CTRL                      0x026 /* External LNA control */
#define AD9361_REG_GPO_FORCE_AND_INIT                     0x027 /* GPO Force and Init */
#define AD9361_REG_GPO0_RX_DELAY                          0x028 /* GPO0 RX delay */
#define AD9361_REG_GPO1_RX_DELAY                          0x029 /* GPO1 RX delay */
#define AD9361_REG_GPO2_RX_DELAY                          0x02A /* GPO2 RX delay */
#define AD9361_REG_GPO3_RX_DELAY                          0x02B /* GPO3 RX delay */
#define AD9361_REG_GPO0_TX_DELAY                          0x02C /* GPO0 TX Delay */
#define AD9361_REG_GPO1_TX_DELAY                          0x02D /* GPO1 TX Delay */
#define AD9361_REG_GPO2_TX_DELAY                          0x02E /* GPO2 TX Delay */
#define AD9361_REG_GPO3_TX_DELAY                          0x02F /* GPO3 TX Delay */
#define AD9361_REG_AUXDAC1_RX_DELAY                       0x030 /* AuxDAC1 RX Delay */
#define AD9361_REG_AUXDAC1_TX_DELAY                       0x031 /* AuxDAC1 TX Delay */
#define AD9361_REG_AUXDAC2_RX_DELAY                       0x032 /* AuxDAC2 RX Delay */
#define AD9361_REG_AUXDAC2_TX_DELAY                       0x033 /* AuxDAC2 TX Delay */
#define AD9361_REG_CTRL_OUTPUT_POINTER                    0x035 /* Control Output Pointer */
#define AD9361_REG_CTRL_OUTPUT_ENABLE                     0x036 /* Control Output Enable */
#define AD9361_REG_PRODUCT_ID                             0x037 /* Product ID */
#define AD9361_REG_REFERENCE_CLOCK_CYCLES                 0x03A /* Reference Clock Cycles */
#define AD9361_REG_DIGITAL_IO_CTRL                        0x03B /* Digital I/O Control */
#define AD9361_REG_LVDS_BIAS_CTRL                         0x03C /* LVDS Bias control */
#define AD9361_REG_LVDS_INVERT_CTRL1                      0x03D /* LVDS Invert control1 */
#define AD9361_REG_LVDS_INVERT_CTRL2                      0x03E /* LVDS Invert control2 */
#define AD9361_REG_SDM_CTRL_1                             0x03F /* SDM Control 1 */
#define AD9361_REG_FRACT_BB_FREQ_WORD_1                   0x041 /* Fractional BB Freq Word 1 */
#define AD9361_REG_FRACT_BB_FREQ_WORD_2                   0x042 /* Fractional BB Freq Word 2 */
#define AD9361_REG_FRACT_BB_FREQ_WORD_3                   0x043 /* Fractional BB Freq Word 3 */
#define AD9361_REG_INTEGER_BB_FREQ_WORD                   0x044 /* Integer BB Freq Word */
#define AD9361_REG_CLOCK_CTRL                             0x045 /* Clock Control */
#define AD9361_REG_CP_CURRENT                             0x046 /* CP Current */
#define AD9361_REG_CP_BLEED_CURRENT                       0x047 /* CP Bleed Current */
#define AD9361_REG_LOOP_FILTER_1                          0x048 /* Loop Filter 1 */
#define AD9361_REG_LOOP_FILTER_2                          0x049 /* Loop Filter 2 */
#define AD9361_REG_LOOP_FILTER_3                          0x04A /* Loop Filter 3 */
#define AD9361_REG_VCO_CTRL                               0x04B /* VCO Control */
#define AD9361_REG_VCO_PROGRAM_1                          0x04C
#define AD9361_REG_VCO_PROGRAM_2                          0x04D
#define AD9361_REG_SDM_CTRL                               0x04E /* SDM Control */
#define AD9361_REG_RX_SYNTH_POWER_DOWN_OVERRIDE           0x050 /* RX Synth Power Down Override */
#define AD9361_REG_TX_SYNTH_POWER_DOWN_OVERRIDE           0x051 /* TX Synth Power Down Override */
#define AD9361_REG_RX_ANALOG_POWER_DOWN_OVERRIDE_1        0x052 /* RX Analog Power Down Override 1 */
#define AD9361_REG_RX_ANALOG_POWER_DOWN_OVERRIDE_2        0x053 /* RX Analog Power Down Override 2 */
#define AD9361_REG_RX1_ADC_POWER_DOWN_OVERRIDE            0x054 /* RX1 ADC Power Down Override */
#define AD9361_REG_RX2_ADC_POWER_DOWN_OVERRIDE            0x055 /* RX2 ADC Power Down Override */
#define AD9361_REG_TX_ANALOG_POWER_DOWN_OVERRIDE_1        0x056 /* TX Analog Power Down Override 1 */
#define AD9361_REG_ANALOG_POWER_DOWN_OVERRIDE             0x057 /* Analog Power Down Override */
#define AD9361_REG_MISC_POWER_DOWN_OVERRIDE               0x058 /* Misc Power Down Override */
#define AD9361_REG_CH_1_OVERFLOW                          0x05E /* CH 1 Overflow */
#define AD9361_REG_CH_2_OVERFLOW                          0x05F /* CH 2 Overflow */
#define AD9361_REG_TX_FILTER_COEF_ADDR                    0x060 /* TX Filter Coefficient Address */
#define AD9361_REG_TX_FILTER_COEF_WRITE_DATA_1            0x061 /* TX Filter Coefficient Write Data 1 */
#define AD9361_REG_TX_FILTER_COEF_WRITE_DATA_2            0x062 /* TX Filter Coefficient Write Data 2 */
#define AD9361_REG_TX_FILTER_COEF_READ_DATA_1             0x063 /* TX Filter Coefficient Read Data 1 */
#define AD9361_REG_TX_FILTER_COEF_READ_DATA_2             0x064 /* TX Filter Coefficient Read Data 2 */
#define AD9361_REG_TX_FILTER_CONF                         0x065 /* TX Filter Configuration */
#define AD9361_REG_TX_MON_LOW_GAIN                        0x067 /* TX Mon Low Gain */
#define AD9361_REG_TX_MON_HIGH_GAIN                       0x068 /* TX Mon High Gain */
#define AD9361_REG_TX_MON_DELAY                           0x069 /* TX Mon Delay */
#define AD9361_REG_TX_LEVEL_THRESH                        0x06A /* TX Level Threshold */
#define AD9361_REG_TX_RSSI1                               0x06B /* TX RSSI1 */
#define AD9361_REG_TX_RSSI2                               0x06C /* TX RSSI2 */
#define AD9361_REG_TX_RSSI_LSB                            0x06D /* TX RSSI LSB */
#define AD9361_REG_TPM_MODE_ENABLE                        0x06E /* TPM Mode Enable */
#define AD9361_REG_TX_MON_TEMP_GAIN_COEF                  0x06F /* Temp Gain Coefficient */
#define AD9361_REG_TX_MON_1_CONFIG                        0x070 /* TX Mon 1 Config */
#define AD9361_REG_TX_MON_2_CONFIG                        0x071 /* TX Mon 2 Config */
#define AD9361_REG_TX1_ATTEN_0                            0x073 /* TX1 Atten 0 */
#define AD9361_REG_TX1_ATTEN_1                            0x074 /* TX1 Atten 1 */
#define AD9361_REG_TX2_ATTEN_0                            0x075 /* TX2 Atten 0 */
#define AD9361_REG_TX2_ATTEN_1                            0x076 /* TX2 Atten 1 */
#define AD9361_REG_TX_ATTEN_OFFSET                        0x077 /* TX Atten Offset */
#define AD9361_REG_TX_ATTEN_THRESH                        0x078 /* TX Atten Threshold */
#define AD9361_REG_TX1_DIG_ATTEN                          0x079 /* TX1 Dig Attenuation */
#define AD9361_REG_TX2_DIG_ATTEN                          0x07C /* TX2 Dig Attenuation */
#define AD9361_REG_TX1_SYMBOL_ATTEN                       0x07F /* TX1 Symbol Attenuation */
#define AD9361_REG_TX2_SYMBOL_ATTEN                       0x080 /* TX2 Symbol Attenuation */
#define AD9361_REG_TX_SYMBOL_ATTEN_CONFIG                 0x081 /* TX Symbol Atten Config */
#define AD9361_REG_TX1_OUT_1_PHASE_CORR                   0x08E /* TX1 Out 1 Phase Corr */
#define AD9361_REG_TX1_OUT_1_GAIN_CORR                    0x08F /* TX1 Out 1 Gain Corr */
#define AD9361_REG_TX2_OUT_1_PHASE_CORR                   0x090 /* TX2 Out 1 Phase Corr */
#define AD9361_REG_TX2_OUT_1_GAIN_CORR                    0x091 /* TX2 Out 1 Gain Corr */
#define AD9361_REG_TX1_OUT_1_OFFSET_I                     0x092 /* TX1 Out 1 Offset I */
#define AD9361_REG_TX1_OUT_1_OFFSET_Q                     0x093 /* TX1 Out 1 Offset Q */
#define AD9361_REG_TX2_OUT_1_OFFSET_I                     0x094 /* TX2 Out 1 Offset I */
#define AD9361_REG_TX2_OUT_1_OFFSET_Q                     0x095 /* TX2 Out 1 Offset Q */
#define AD9361_REG_TX1_OUT_2_PHASE_CORR                   0x096 /* TX1 Out 2 Phase Corr */
#define AD9361_REG_TX1_OUT_2_GAIN_CORR                    0x097 /* TX1 Out 2 Gain Corr */
#define AD9361_REG_TX2_OUT_2_PHASE_CORR                   0x098 /* TX2 Out 2 Phase Corr */
#define AD9361_REG_TX2_OUT_2_GAIN_CORR                    0x099 /* TX2 Out 2 Gain Corr */
#define AD9361_REG_TX1_OUT_2_OFFSET_I                     0x09A /* TX1 Out 2 Offset I */
#define AD9361_REG_TX1_OUT_2_OFFSET_Q                     0x09B /* TX1 Out 2 Offset Q */
#define AD9361_REG_TX2_OUT_2_OFFSET_I                     0x09C /* TX2 Out 2 Offset I */
#define AD9361_REG_TX2_OUT_2_OFFSET_Q                     0x09D /* TX2 Out 2 Offset Q */
#define AD9361_REG_TX_FORCE_BITS                          0x09F /* Force Bits */
#define AD9361_REG_QUAD_CAL_NCO_FREQ_PHASE_OFFSET         0x0A0 /* Quad Cal NCO Freq & Phase Offset */
#define AD9361_REG_QUAD_CAL_CTRL                          0x0A1 /* Quad Cal Control */
#define AD9361_REG_KEXP_1                                 0x0A2 /* Kexp 1 */
#define AD9361_REG_KEXP_2                                 0x0A3 /* Kexp 2 */
#define AD9361_REG_QUAD_SETTLE_COUNT                      0x0A4 /* QUAD Settle count */
#define AD9361_REG_MAG_FTEST_THRESH                       0x0A5 /* Mag. Ftest Thresh */
#define AD9361_REG_MAG_FTEST_THRESH_2                     0x0A6 /* Mag. Ftest Thresh 2 */
#define AD9361_REG_QUAD_CAL_STATUS_TX1                    0x0A7 /* Quad cal status TX1 */
#define AD9361_REG_QUAD_CAL_STATUS_TX2                    0x0A8 /* Quad cal status TX2 */
#define AD9361_REG_QUAD_CAL_COUNT                         0x0A9 /* Quad cal Count */
#define AD9361_REG_TX_QUAD_FULL_LMT_GAIN                  0x0AA /* TX Quad Full/LMT Gain */
#define AD9361_REG_SQUARER_CONFIG                         0x0AB /* Squarer Config */
#define AD9361_REG_TX_QUAD_CAL_ATTEN                      0x0AC /* TX Quad Cal Atten */
#define AD9361_REG_THRESH_ACCUM                           0x0AD /* Thresh Accum */
#define AD9361_REG_TX_QUAD_LPF_GAIN                       0x0AE /* TX Quad LPF Gain */
#define AD9361_REG_TXDAC_VDS_I                            0x0B0 /* TXDAC Vds I */
#define AD9361_REG_TXDAC_VDS_Q                            0x0B1 /* TXDAC Vds Q */
#define AD9361_REG_TXDAC_GN_I                             0x0B2 /* TXDAC gn I */
#define AD9361_REG_TXDAC_GN_Q                             0x0B3 /* TXDAC gn Q */
#define AD9361_REG_TXBBF_OPAMP_A                          0x0C0 /* TXBBF OpAmp A */
#define AD9361_REG_TXBBF_OPAMP_B                          0x0C1 /* TXBBF OpAmp B */
#define AD9361_REG_TX_BBF_R1                              0x0C2 /* TX BBF R1 */
#define AD9361_REG_TX_BBF_R2                              0x0C3 /* TX BBF R2 */
#define AD9361_REG_TX_BBF_R3                              0x0C4 /* TX BBF R3 */
#define AD9361_REG_TX_BBF_R4                              0x0C5 /* TX BBF R4 */
#define AD9361_REG_TX_BBF_RP                              0x0C6 /* TX BBF RP */
#define AD9361_REG_TX_BBF_C1                              0x0C7 /* TX BBF C1 */
#define AD9361_REG_TX_BBF_C2                              0x0C8 /* TX BBF C2 */
#define AD9361_REG_TX_BBF_CP                              0x0C9 /* TX BBF Cp */
#define AD9361_REG_TX_TUNE_CTRL                           0x0CA /* TX Tune Control */
#define AD9361_REG_TX_BBF_R2B                             0x0CB /* TX BBF R2b */
#define AD9361_REG_TX_BBF_TUNE                            0x0CC /* TX BBF Tune */
#define AD9361_REG_CONFIG0                                0x0D0 /* Config0 */
#define AD9361_REG_RESISTOR                               0x0D1 /* Resistor */
#define AD9361_REG_CAPACITOR                              0x0D2 /* Capacitor */
#define AD9361_REG_LO_CM                                  0x0D3 /* LO CM */
#define AD9361_REG_TX_BBF_TUNE_DIVIDER                    0x0D6 /* TX BBF Tune Divider */
#define AD9361_REG_TX_BBF_TUNE_MODE                       0x0D7 /* TX BBF Tune Mode */
#define AD9361_REG_RX_FILTER_COEF_ADDR                    0x0F0 /* RX Filter Coeff Addr */
#define AD9361_REG_RX_FILTER_COEF_DATA_1                  0x0F1 /* RX Filter Coeff Data 1 */
#define AD9361_REG_RX_FILTER_COEF_DATA_2                  0x0F2 /* RX Filter Coeff Data 2 */
#define AD9361_REG_RX_FILTER_COEF_READ_DATA_1             0x0F3 /* RX Filter Coeff Read Data 1 */
#define AD9361_REG_RX_FILTER_COEF_READ_DATA_2             0x0F4 /* RX Filter Coeff Read Data 2 */
#define AD9361_REG_RX_FILTER_CONFIG                       0x0F5 /* RX Filter Config */
#define AD9361_REG_RX_FILTER_GAIN                         0x0F6 /* RX Filter Gain */
#define AD9361_REG_AGC_CONFIG_1                           0x0FA /* AGC Config1 */
#define AD9361_REG_AGC_CONFIG_2                           0x0FB /* AGC config2 */
#define AD9361_REG_AGC_CONFIG_3                           0x0FC /* AGC Config3 */
#define AD9361_REG_MAX_LMT_FULL_GAIN                      0x0FD /* Max LMT/Full Gain */
#define AD9361_REG_PEAK_WAIT_TIME                         0x0FE /* Peak Wait Time */
#define AD9361_REG_DIGITAL_GAIN                           0x100 /* Digital Gain */
#define AD9361_REG_AGC_LOCK_LEVEL                         0x101 /* AGC Lock Level */
#define AD9361_REG_ADC_NOISE_CORRECTION_FACTOR            0x102 /* ADC noise Correction Factor */
#define AD9361_REG_GAIN_STP_CONFIG1                       0x103 /* Gain Step Config1 */
#define AD9361_REG_ADC_SMALL_OVERLOAD_THRESH              0x104 /* ADC Small Overload Threshold */
#define AD9361_REG_ADC_LARGE_OVERLOAD_THRESH              0x105 /* ADC Large Overload Threshold */
#define AD9361_REG_GAIN_STP_CONFIG_2                      0x106 /* Gain Step Config 2 */
#define AD9361_REG_SMALL_LMT_OVERLOAD_THRESH              0x107 /* Small LMT Overload Threshold */
#define AD9361_REG_LARGE_LMT_OVERLOAD_THRESH              0x108 /* Large LMT Overload Threshold */
#define AD9361_REG_RX1_MANUAL_LMT_FULL_GAIN               0x109 /* RX1 Manual LMT/Full Gain */
#define AD9361_REG_RX1_MANUAL_LPF_GAIN                    0x10A /* RX1 Manual LPF gain */
#define AD9361_REG_RX1_MANUAL_DIGITALFORCED_GAIN          0x10B /* RX1 Manual Digital/Forced Gain */
#define AD9361_REG_RX2_MANUAL_LMT_FULL_GAIN               0x10C /* RX2 Manual LMT/Full Gain */
#define AD9361_REG_RX2_MANUAL_LPF_GAIN                    0x10D /* RX2 Manual LPF Gain */
#define AD9361_REG_RX2_MANUAL_DIGITALFORCED_GAIN          0x10E /* RX2 Manual Digital/Forced Gain */
#define AD9361_REG_FAST_CONFIG_1                          0x110 /* Config 1 */
#define AD9361_REG_FAST_CONFIG_2_SETTLING_DELAY           0x111 /* Config 2 & Settling Delay */
#define AD9361_REG_FAST_ENERGY_LOST_THRESH                0x112 /* Energy Lost Threshold */
#define AD9361_REG_FAST_STRONGER_SIGNAL_THRESH            0x113 /* Stronger Signal Threshold */
#define AD9361_REG_FAST_LOW_POWER_THRESH                  0x114 /* Low Power Threshold */
#define AD9361_REG_FAST_STRONG_SIGNAL_FREEZE              0x115 /* Strong Signal Freeze */
#define AD9361_REG_FAST_FINAL_OVER_RANGE_AND_OPT_GAIN     0x116 /* Final Over Range and Opt Gain */
#define AD9361_REG_FAST_ENERGY_DETECT_COUNT               0x117 /* Energy Detect Count */
#define AD9361_REG_FAST_AGCLL_UPPER_LIMIT                 0x118 /* AGCLL Upper Limit */
#define AD9361_REG_FAST_GAIN_LOCK_EXIT_COUNT              0x119 /* Gain Lock Exit Count */
#define AD9361_REG_FAST_INITIAL_LMT_GAIN_LIMIT            0x11A /* Initial LMT Gain Limit */
#define AD9361_REG_FAST_INCREMENT_TIME                    0x11B /* Increment Time */
#define AD9361_REG_AGC_INNER_LOW_THRESH                   0x120 /* AGC Inner Low Threshold */
#define AD9361_REG_LMT_OVERLOAD_COUNTERS                  0x121 /* LMT Overload Counters */
#define AD9361_REG_ADC_OVERLOAD_COUNTERS                  0x122 /* ADC Overload Counters */
#define AD9361_REG_GAIN_STP1                              0x123 /* Gain Step1 */
#define AD9361_REG_GAIN_UPDATE_COUNTER1                   0x124 /* Gain Update Counter1 */
#define AD9361_REG_GAIN_UPDATE_COUNTER2                   0x125 /* Gain Update Counter2 */
#define AD9361_REG_DIGITAL_SAT_COUNTER                    0x128 /* Digital Sat Counter */
#define AD9361_REG_OUTER_POWER_THRESHS                    0x129 /* Outer Power Thresholds */
#define AD9361_REG_GAIN_STP_2                             0x12A /* Gain Step 2 */
#define AD9361_REG_EXT_LNA_HIGH_GAIN                      0x12C /* Ext LNA High Gain */
#define AD9361_REG_EXT_LNA_LOW_GAIN                       0x12D /* Ext LNA Low Gain */
#define AD9361_REG_GAIN_TABLE_ADDRESS                     0x130 /* Gain Table Address */
#define AD9361_REG_GAIN_TABLE_WRITE_DATA1                 0x131 /* Gain Table Write Data1 */
#define AD9361_REG_GAIN_TABLE_WRITE_DATA2                 0x132 /* Gain Table Write Data2 */
#define AD9361_REG_GAIN_TABLE_WRITE_DATA3                 0x133 /* Gain Table Write Data 3 */
#define AD9361_REG_GAIN_TABLE_READ_DATA1                  0x134 /* Gain Table Read Data 1 */
#define AD9361_REG_GAIN_TABLE_READ_DATA2                  0x135 /* Gain Table Read Data 2 */
#define AD9361_REG_GAIN_TABLE_READ_DATA3                  0x136 /* Gain Table Read Data 3 */
#define AD9361_REG_GAIN_TABLE_CONFIG                      0x137 /* Gain Table Config */
#define AD9361_REG_GM_SUB_TABLE_ADDRESS                   0x138 /* Gm Sub Table Address */
#define AD9361_REG_GM_SUB_TABLE_GAIN_WRITE                0x139 /* Gm Sub Table Gain Word Write */
#define AD9361_REG_GM_SUB_TABLE_BIAS_WRITE                0x13A /* Gm Sub Table Bias Word Write */
#define AD9361_REG_GM_SUB_TABLE_CTRL_WRITE                0x13B /* Gm Sub Table Control Word Write */
#define AD9361_REG_GM_SUB_TABLE_GAIN_READ                 0x13C /* Gm Sub Table Gain Word Read */
#define AD9361_REG_GM_SUB_TABLE_BIAS_READ                 0x13D /* Gm Sub Table Bias Word Read */
#define AD9361_REG_GM_SUB_TABLE_CTRL_READ                 0x13E /* Gm Sub Table Control Word Read */
#define AD9361_REG_GM_SUB_TABLE_CONFIG                    0x13F /* Gm Sub Table Config */
#define AD9361_REG_WORD_ADDRESS                           0x140 /* Word Address */
#define AD9361_REG_GAIN_DIFF_WORDERROR_WRITE              0x141 /* Gain Diff Word/Error Write */
#define AD9361_REG_GAIN_ERROR_READ                        0x142 /* Gain Error Read */
#define AD9361_REG_CONFIG                                 0x143 /* Config */
#define AD9361_REG_LNA_GAIN_DIFF_READ_BACK                0x144 /* LNA Gain Diff Read Back */
#define AD9361_REG_MAX_MIXER_CALIBRATION_GAIN_INDEX       0x145 /* Max Mixer Calibration Gain Index */
#define AD9361_REG_TEMP_GAIN_COEF                         0x146 /* Temp Gain Coefficient */
#define AD9361_REG_SETTLE_TIME                            0x147 /* Settle Time */
#define AD9361_REG_MEASURE_DURATION                       0x148 /* Measure Duration */
#define AD9361_REG_CAL_TEMP_SENSOR_WORD                   0x149 /* Cal Temp sensor word */
#define AD9361_REG_MEASURE_DURATION_01                    0x150 /* Measure Duration 0&1 */
#define AD9361_REG_MEASURE_DURATION_23                    0x151 /* Measure Duration 2&3 */
#define AD9361_REG_RSSI_WEIGHT_0                          0x152 /* RSSI Weight 0 */
#define AD9361_REG_RSSI_WEIGHT_1                          0x153 /* RSSI Weight 1 */
#define AD9361_REG_RSSI_WEIGHT_2                          0x154 /* RSSI Weight 2 */
#define AD9361_REG_RSSI_WEIGHT_3                          0x155 /* RSSI Weight 3 */
#define AD9361_REG_RSSI_DELAY                             0x156 /* RSSI delay */
#define AD9361_REG_RSSI_WAIT_TIME                         0x157 /* RSSI wait time */
#define AD9361_REG_RSSI_CONFIG                            0x158 /* RSSI Config */
#define AD9361_REG_ADC_MEASURE_DURATION_01                0x159 /* ADC Measure Duration 0&1 */
#define AD9361_REG_ADC_WEIGHT_0                           0x15A /* ADC Weight 0 */
#define AD9361_REG_ADC_WEIGHT_1                           0x15B /* ADC Weight 1 */
#define AD9361_REG_DEC_POWER_MEASURE_DURATION_0           0x15C /* Dec Power Measure Duration 0 */
#define AD9361_REG_LNA_GAIN                               0x15D /* LNA Gain */
#define AD9361_REG_CH1_ADC_POWER                          0x160 /* CH1 ADC Power */
#define AD9361_REG_CH1_RX_FILTER_POWER                    0x161 /* CH1 RX filter Power */
#define AD9361_REG_CH2_ADC_POWER                          0x162 /* CH2 ADC Power */
#define AD9361_REG_CH2_RX_FILTER_POWER                    0x163 /* CH2 RX filter Power */
#define AD9361_REG_RX_QUAD_CAL_LEVEL                      0x168 /* RX Quad Cal Level */
#define AD9361_REG_CALIBRATION_CONFIG_1                   0x169 /* Calibration Config 1 */
#define AD9361_REG_CALIBRATION_CONFIG_2                   0x16A /* Calibration config2 */
#define AD9361_REG_CALIBRATION_CONFIG_3                   0x16B /* Calibration config3 */
#define AD9361_REG_CALIB_COUNT                            0x16C /* Calib count */
#define AD9361_REG_SETTLE_COUNT                           0x16D /* Settle count */
#define AD9361_REG_RX_QUAD_GAIN1                          0x16E /* RX Quad gain1 */
#define AD9361_REG_RX_QUAD_GAIN2                          0x16F /* RX Quad gain2 */
#define AD9361_REG_RX1_INPUT_A_PHASE_CORR                 0x170 /* RX1 Input A Phase Corr */
#define AD9361_REG_RX1_INPUT_A_GAIN_CORR                  0x171 /* RX1 Input A Gain Corr */
#define AD9361_REG_RX2_INPUT_A_PHASE_CORR                 0x172 /* RX2 Input A Phase Corr */
#define AD9361_REG_RX2_INPUT_A_GAIN_CORR                  0x173 /* RX2 Input A Gain Corr */
#define AD9361_REG_RX1_INPUT_A_Q_OFFSET                   0x174 /* RX1 Input A Q" Offset */
#define AD9361_REG_RX1_INPUT_A_OFFSETS                    0x175 /* RX1 Input A Offsets */
#define AD9361_REG_INPUT_A_OFFSETS_1                      0x176 /* Input A Offsets 1 */
#define AD9361_REG_RX2_INPUT_A_OFFSETS                    0x177 /* RX2 Input A Offsets */
#define AD9361_REG_RX2_INPUT_A_I_OFFSET                   0x178 /* RX2 Input A "I" Offset */
#define AD9361_REG_RX1_INPUT_BC_PHASE_CORR                0x179 /* RX1 Input B&C Phase Corr */
#define AD9361_REG_RX1_INPUT_BC_GAIN_CORR                 0x17A /* RX1 Input B&C Gain Corr */
#define AD9361_REG_RX2_INPUT_BC_PHASE_CORR                0x17B /* RX2 Input B&C Phase Corr */
#define AD9361_REG_RX2_INPUT_BC_GAIN_CORR                 0x17C /* RX2 Input B&C Gain Corr */
#define AD9361_REG_RX1_INPUT_BC_Q_OFFSET                  0x17D /* RX1 Input B&C "Q" Offset */
#define AD9361_REG_RX1_INPUT_BC_OFFSETS                   0x17E /* RX1 Input B&C Offsets */
#define AD9361_REG_INPUT_BC_OFFSETS_1                     0x17F /* Input B&C Offsets 1 */
#define AD9361_REG_RX2_INPUT_BC_OFFSETS                   0x180 /* RX2 Input B&C Offsets */
#define AD9361_REG_RX2_INPUT_BC_I_OFFSET                  0x181 /* RX2 Input B&C "I" Offset */
#define AD9361_REG_FORCE_BITS                             0x182 /* Force Bits */
#define AD9361_REG_WAIT_COUNT                             0x185 /* Wait Count */
#define AD9361_REG_RF_DC_OFFSET_COUNT                     0x186 /* RF DC Offset Count */
#define AD9361_REG_RF_DC_OFFSET_CONFIG_1                  0x187 /* RF DC Offset Config1 */
#define AD9361_REG_RF_DC_OFFSET_ATTEN                     0x188 /* RF DC Offset Attenuation */
#define AD9361_REG_INVERT_BITS                            0x189 /* Invert Bits */
#define AD9361_REG_DC_OFFSET_CONFIG2                      0x18B /* DC Offset Config2 */
#define AD9361_REG_RF_CAL_GAIN_INDEX                      0x18C /* RF Cal Gain Index */
#define AD9361_REG_SOI_THRESH                             0x18D /* SOI Threshold */
#define AD9361_REG_BB_DC_OFFSET_SHIFT                     0x190 /* BB DC Offset Shift */
#define AD9361_REG_BB_DC_OFFSET_FAST_SETTLE_SHIFT         0x191 /* BB DC Offset Fast Settle Shift */
#define AD9361_REG_BB_FAST_SETTLE_DUR                     0x192 /* BB Fast Settle Dur */
#define AD9361_REG_BB_DC_OFFSET_COUNT                     0x193 /* BB DC Offset Count */
#define AD9361_REG_BB_DC_OFFSET_ATTEN                     0x194 /* BB DC Offset Attenuation */
#define AD9361_REG_RX1_BB_DC_WORD_I_MSB                   0x19A /* RX1 BB DC word I MSB */
#define AD9361_REG_RX1_BB_DC_WORD_I_LSB                   0x19B /* RX1 BB DC word I LSB */
#define AD9361_REG_RX1_BB_DC_WORD_Q_MSB                   0x19C /* RX1 BB DC word Q MSB */
#define AD9361_REG_RX1_BB_DC_WORD_Q_LSB                   0x19D /* RX1 BB DC word Q LSB */
#define AD9361_REG_RX2_BB_DC_WORD_I_MSB                   0x19E /* RX2 BB DC word I MSB */
#define AD9361_REG_RX2_BB_DC_WORD_I_LSB                   0x19F /* RX2 BB DC word I LSB */
#define AD9361_REG_RX2_BB_DC_WORD_Q_MSB                   0x1A0 /* RX2 BB DC word Q MSB */
#define AD9361_REG_RX2_BB_DC_WORD_Q_LSB                   0x1A1 /* RX2 BB DC word Q LSB */
#define AD9361_REG_BB_TRACK_CORR_WORD_I_MSB               0x1A2 /* BB Track corr word I MSB */
#define AD9361_REG_BB_TRACK_CORR_WORD_I_LSB               0x1A3 /* BB Track corr word I LSB */
#define AD9361_REG_BB_TRACK_CORR_WORD_Q_MSB               0x1A4 /* BB Track corr word Q MSB */
#define AD9361_REG_BB_TRACK_CORR_WORD_Q_LSB               0x1A5 /* BB Track corr word Q LSB */
#define AD9361_REG_RX1_RSSI_SYMBOL                        0x1A7 /* RX1 RSSI Symbol */
#define AD9361_REG_RX1_RSSI_PREAMBLE                      0x1A8 /* RX1 RSSI preamble */
#define AD9361_REG_RX2_RSSI_SYMBOL                        0x1A9 /* RX2 RSSI symbol */
#define AD9361_REG_RX2_RSSI_PREAMBLE                      0x1AA /* RX2 RSSI preamble */
#define AD9361_REG_SYMBOL_LSB                             0x1AB /* Symbol LSB */
#define AD9361_REG_PREAMBLE_LSB                           0x1AC /* Preamble LSB */
#define AD9361_REG_RX_PATH_GAIN_MSB                       0x1AD /* RX Path Gain */
#define AD9361_REG_RX_PATH_GAIN_LSB                       0x1AE /* RX Path Gain */
#define AD9361_REG_RX_DIFF_LNA_FORCE                      0x1B0 /* RX Diff LNA Force */
#define AD9361_REG_RX_LNA_BIAS_COARSE                     0x1B1 /* RX LNA Bias Coarse */
#define AD9361_REG_RX_LNA_BIAS_FINE_0                     0x1B2 /* RX LNA Bias Fine 0 */
#define AD9361_REG_RX_LNA_BIAS_FINE_1                     0x1B3 /* RX LNA Bias Fine 1 */
#define AD9361_REG_RX_MIX_GM_CONFIG                       0x1C0 /* RX Mix Gm Config */
#define AD9361_REG_RX1_MIX_GM_FORCE                       0x1C1 /* RX1 Mix Gm Force */
#define AD9361_REG_RX1_MIX_GM_BIAS_FORCE                  0x1C2 /* RX1 Mix Gm Bias (Force) */
#define AD9361_REG_RX2_MIX_GM_FORCE                       0x1C3 /* RX2 Mix Gm Force */
#define AD9361_REG_RX2_MIX_GM_BIAS_FORCE                  0x1C4 /* RX2 Mix Gm Bias (Force) */
#define AD9361_REG_INPUT_A_MSBS                           0x1C8 /* Input A MSBs */
#define AD9361_REG_INPUT_A_RX1_I                          0x1C9 /* Input A RX1 I */
#define AD9361_REG_INPUT_A_RX1_Q                          0x1CA /* Input A RX1 Q */
#define AD9361_REG_INPUT_A_RX2_I                          0x1CB /* Input A RX2 I */
#define AD9361_REG_INPUT_A_RX2_Q                          0x1CC /* Input A RX2 Q */
#define AD9361_REG_INPUTS_BC_RX1_I                        0x1CD /* Inputs B&C RX1 I */
#define AD9361_REG_BAND1_RX1_Q                            0x1CE /* Band1 RX1 Q */
#define AD9361_REG_INPUTS_BC_RX2_I                        0x1CF /* Inputs B&C RX2 I */
#define AD9361_REG_INPUTS_BC_RX2_Q                        0x1D0 /* Inputs B&C RX2 Q */
#define AD9361_REG_INPUTS_BC_MSBS                         0x1D1 /* Inputs B&C MSBs */
#define AD9361_REG_FORCE_OS_DAC                           0x1D2 /* Force OS DAC */
#define AD9361_REG_RX_MIX_LO_CM                           0x1D5 /* RX Mix LO CM */
#define AD9361_REG_RX_CGB_SEG_ENABLE                      0x1D6 /* RX CGB Seg Enable */
#define AD9361_REG_RX_MIX_INPUTBIAS                       0x1D7 /* RX Mix Input/Bias */
#define AD9361_REG_RX_TIA_CONFIG                          0x1DB /* RX TIA Config */
#define AD9361_REG_TIA1_C_LSB                             0x1DC /* TIA1 C LSB */
#define AD9361_REG_TIA1_C_MSB                             0x1DD /* TIA1 C MSB */
#define AD9361_REG_TIA2_C_LSB                             0x1DE /* TIA2 C LSB */
#define AD9361_REG_TIA2_C_MSB                             0x1DF /* TIA2 C MSB */
#define AD9361_REG_RX1_BBF_R1A                            0x1E0 /* RX1 BBF R1A */
#define AD9361_REG_RX2_BBF_R1A                            0x1E1 /* RX2 BBF R1A */
#define AD9361_REG_RX1_TUNE_CTRL                          0x1E2 /* RX1 Tune Control */
#define AD9361_REG_RX2_TUNE_CTRL                          0x1E3 /* RX2 Tune Control */
#define AD9361_REG_RX1_BBF_R5                             0x1E4 /* RX1 BBF R5 */
#define AD9361_REG_RX2_BBF_R5                             0x1E5 /* RX2 BBF R5 */
#define AD9361_REG_RX_BBF_R2346                           0x1E6 /* RX BBF R2346 */
#define AD9361_REG_RX_BBF_C1_MSB                          0x1E7 /* RX BBF C1 MSB */
#define AD9361_REG_RX_BBF_C1_LSB                          0x1E8 /* RX BBF C1 LSB */
#define AD9361_REG_RX_BBF_C2_MSB                          0x1E9 /* RX BBF C2 MSB */
#define AD9361_REG_RX_BBF_C2_LSB                          0x1EA /* RX BBF C2 LSB */
#define AD9361_REG_RX_BBF_C3_MSB                          0x1EB /* RX BBF C3 MSB */
#define AD9361_REG_RX_BBF_C3_LSB                          0x1EC /* RX BBF C3 LSB */
#define AD9361_REG_RX_BBF_CC1_CTR                         0x1ED /* RX BBF CC1 Ctr */
#define AD9361_REG_RX_BBF_POW_RZ_BYTE0                    0x1EE /* RX BBF Pow Rz Byte0 */
#define AD9361_REG_RX_BBF_CC2_CTR                         0x1EF /* RX BBF CC2 Ctr */
#define AD9361_REG_RX_BBF_POW_RZ_BYTE1                    0x1F0 /* RX BBF Pow Rz Byte1 */
#define AD9361_REG_RX_BBF_CC3_CTR                         0x1F1 /* RX BBF CC3 Ctr */
#define AD9361_REG_RX_BBF_R5_TUNE                         0x1F2 /* RX BBF R5 Tune */
#define AD9361_REG_RX_BBF_TUNE                            0x1F3 /* RX BBF Tune */
#define AD9361_REG_RX1_BBF_MAN_GAIN                       0x1F4 /* RX1 BBF Man Gain */
#define AD9361_REG_RX2_BBF_MAN_GAIN                       0x1F5 /* RX2 BBF Man Gain */
#define AD9361_REG_RX_BBF_TUNE_DIVIDE                     0x1F8 /* RX BBF Tune Divide */
#define AD9361_REG_RX_BBF_TUNE_CONFIG                     0x1F9 /* RX BBF Tune Config */
#define AD9361_REG_POLE_GAIN                              0x1FA /* Pole gain */
#define AD9361_REG_RX_BBBW_MHZ                            0x1FB /* RX BBBW MHz */
#define AD9361_REG_RX_BBBW_KHZ                            0x1FC /* RX BBBW kHz */
#define AD9361_REG_FB_DAC_CLK_DELAY1                      0x201 /* FB DAC Clk Delay1 */
#define AD9361_REG_FB_DAC_CLK_DELAY2                      0x202 /* FB DAC Clk Delay2 */
#define AD9361_REG_FLASH_SAMPLE_CLK_DELAY_3P              0x203 /* Flash Sample Clk Delay 3p */
#define AD9361_REG_FLASH_SAMPLE_CLK_DELAY_3N              0x204 /* Flash Sample Clk Delay 3n */
#define AD9361_REG_TEST_MUX_2I                            0x205 /* Test MUX 2i */
#define AD9361_REG_TEST_MUX_2Q                            0x206 /* Test MUX 2q */
#define AD9361_REG_INTEGRATOR_1_RESISTANCE                0x207 /* Integrator 1 Resistance */
#define AD9361_REG_INTEGRATOR_1_CAPACITANCE               0x208 /* Integrator 1 Capacitance */
#define AD9361_REG_INTEGRATOR_23_RESISTANCE               0x209 /* Integrator 23 Resistance */
#define AD9361_REG_INTEGRATOR_2_RESISTANCE                0x20A /* Integrator 2 Resistance */
#define AD9361_REG_INTEGRATOR_2_CAPACITANCE               0x20B /* Integrator 2 Capacitance */
#define AD9361_REG_INTEGRATOR_3_RESISTANCE                0x20C /* Integrator 3 Resistance */
#define AD9361_REG_INTEGRATOR_3_CAPACITANCE               0x20D /* Integrator 3 Capacitance */
#define AD9361_REG_INTEGRATOR_AMP_CC                      0x20E /* Integrator Amp Cc */
#define AD9361_REG_INT_1_FB_DAC_NMOS_CURRENT_SOURCE       0x20F /* Int 1 FB DAC NMOS Current Source */
#define AD9361_REG_INT_1_FB_DAC_NMOS_CASOADE_BIAS_CURRENT 0x210 /* Int 1 FB DAC NMOS Casoade Bias Current */
#define AD9361_REG_INT_1_FB_DAC_PMOS_CURRENT_SOURCE       0x211 /* Int 1 FB DAC PMOS Current Source */
#define AD9361_REG_INT_2_FB_DAC_NMOS_CURRENT_SOURCE       0x212 /* Int 2 FB DAC NMOS Current Source */
#define AD9361_REG_INT_2_FB_DAC_NMOS_CASCODE_BIAS_CURRENT 0x213 /* Int 2 FB DAC NMOS Cascode Bias Current */
#define AD9361_REG_INT_2_FB_DAC_PMOS_CURRENT_SOURCE       0x214 /* Int 2 FB DAC PMOS Current Source */
#define AD9361_REG_INT_3_FB_DAC_NMOS_CURRENT_SOURCE       0x215 /* Int 3 FB DAC NMOS Current Source */
#define AD9361_REG_INT_3_FB_DAC_NMOS_CASCODE_BIAS_CURRENT 0x216 /* Int 3 FB DAC NMOS Cascode Bias Current */
#define AD9361_REG_INT_3_FB_DAC_PMOS_CURRENT_SOURCE       0x217 /* Int 3 FB DAC PMOS Current Source */
#define AD9361_REG_FB_DAC_BIAS_CURRENT                    0x218 /* FB DAC Bias Current */
#define AD9361_REG_INT_1_1ST_STAGE_CURRENT                0x219 /* Int 1 1st Stage Current */
#define AD9361_REG_INT_1_1ST_STAGE_CASCODE_CURRENT        0x21A /* Int 1 1st Stage Cascode Current */
#define AD9361_REG_INT_1_2ND_STAGE_CURRENT                0x21B /* Int 1 2nd Stage Current */
#define AD9361_REG_INTEGRATOR_2_1ST_STAGE_CURRENT         0x21C /* Integrator 2 1st Stage Current */
#define AD9361_REG_INT_2_1ST_STAGE_CASCODE_CURRENT        0x21D /* Int 2 1st Stage Cascode Current */
#define AD9361_REG_INT_2_2ND_STAGE_CURRENT                0x21E /* Int 2 2nd Stage Current */
#define AD9361_REG_INT_3_1ST_STAGE_CURRENT                0x21F /* Int 3 1st Stage Current */
#define AD9361_REG_INT_3_1ST_STAGE_CASCODE_CURRENT        0x220 /* Int 3 1st Stage Cascode Current */
#define AD9361_REG_INT_3_2ND_STAGE_CURRENT                0x221 /* Int 3 2nd Stage Current */
#define AD9361_REG_FLASH_BIAS_CURRENT                     0x222 /* Flash Bias Current */
#define AD9361_REG_FLASH_LADDER_BIAS                      0x223 /* Flash Ladder Bias */
#define AD9361_REG_FLASH_LADDER_CASCODE_CURRENT           0x224 /* Flash Ladder Cascode Current */
#define AD9361_REG_FLASH_LADDER_BIAS2                     0x225 /* Flash Ladder Bias2 */
#define AD9361_REG_RESET                                  0x226 /* Reset */
#define AD9361_REG_RX_PFD_CONFIG                          0x230 /* RX PFD Config */
#define AD9361_REG_RX_INTEGER_BYTE_0                      0x231 /* RX Integer Byte 0 */
#define AD9361_REG_RX_INTEGER_BYTE_1                      0x232 /* RX Integer Byte 1 */
#define AD9361_REG_RX_FRACT_BYTE_0                        0x233 /* RX Fractional Byte 0 */
#define AD9361_REG_RX_FRACT_BYTE_1                        0x234 /* RX Fractional Byte 1 */
#define AD9361_REG_RX_FRACT_BYTE_2                        0x235 /* RX Fractional Byte 2 */
#define AD9361_REG_RX_FORCE_ALC                           0x236 /* RX Force ALC */
#define AD9361_REG_RX_FORCE_VCO_TUNE_0                    0x237 /* RX Force VCO Tune 0 */
#define AD9361_REG_RX_FORCE_VCO_TUNE_1                    0x238 /* RX Force VCO Tune 1 */
#define AD9361_REG_RX_ALC_VARACTOR                        0x239 /* RX ALC/Varactor */
#define AD9361_REG_RX_VCO_OUTPUT                          0x23A /* RX VCO Output */
#define AD9361_REG_RX_CP_CURRENT                          0x23B /* RX CP Current */
#define AD9361_REG_RX_CP_OFFSET                           0x23C /* RX CP Offset */
#define AD9361_REG_RX_CP_CONFIG                           0x23D /* RX CP Config */
#define AD9361_REG_RX_LOOP_FILTER_1                       0x23E /* RX Loop Filter 1 */
#define AD9361_REG_RX_LOOP_FILTER_2                       0x23F /* RX Loop Filter 2 */
#define AD9361_REG_RX_LOOP_FILTER_3                       0x240 /* RX Loop Filter 3 */
#define AD9361_REG_RX_DITHERCP_CAL                        0x241 /* RX Dither/CP Cal */
#define AD9361_REG_RX_VCO_BIAS_1                          0x242 /* RX VCO Bias 1 */
#define AD9361_REG_RX_CAL_STATUS                          0x244 /* RX Cal Status */
#define AD9361_REG_RX_VCO_CAL_REF                         0x245 /* RX VCO Cal Ref */
#define AD9361_REG_RX_VCO_PD_OVERRIDES                    0x246 /* RX VCO Pd Overrides */
#define AD9361_REG_RX_CP_OVERRANGE_VCO_LOCK               0x247 /* RX CP Over Range/VCO Lock */
#define AD9361_REG_RX_VCO_LDO                             0x248 /* RX VCO LDO */
#define AD9361_REG_RX_VCO_CAL                             0x249 /* RX VCO Cal */
#define AD9361_REG_RX_LOCK_DETECT_CONFIG                  0x24A /* RX Lock Detect Config */
#define AD9361_REG_RX_CP_LEVEL_DETECT                     0x24B /* RX CP Level Detect */
#define AD9361_REG_RX_DSM_SETUP_0                         0x24C /* RX DSM Setup 0 */
#define AD9361_REG_RX_DSM_SETUP_1                         0x24D /* RX DSM Setup 1 */
#define AD9361_REG_RX_CORRECTION_WORD0                    0x24E /* RX Correction Word0 */
#define AD9361_REG_RX_CORRECTION_WORD1                    0x24F /* RX Correction Word1 */
#define AD9361_REG_RX_VCO_VARACTOR_CTRL_0                 0x250 /* RX VCO Varactor Control 0 */
#define AD9361_REG_RX_VCO_VARACTOR_CTRL_1                 0x251 /* RX VCO Varactor Control 1 */
#define AD9361_REG_RX_FAST_LOCK_SETUP                     0x25A /* RX Fast Lock Setup */
#define AD9361_REG_RX_FAST_LOCK_SETUP_INIT_DELAY          0x25B /* RX Fast Lock Setup Init Delay */
#define AD9361_REG_RX_FAST_LOCK_PROGRAM_ADDR              0x25C /* RX Fast Lock Program Addr */
#define AD9361_REG_RX_FAST_LOCK_PROGRAM_DATA              0x25D /* RX Fast Lock Program Data */
#define AD9361_REG_RX_FAST_LOCK_PROGRAM_READ              0x25E /* RX Fast Lock Program Read */
#define AD9361_REG_RX_FAST_LOCK_PROGRAM_CTRL              0x25F /* RX Fast Lock Program Control */
#define AD9361_REG_RX_LO_GEN_POWER_MODE                   0x261 /* RX LO Gen Power Mode */
#define AD9361_REG_TX_PFD_CONFIG                          0x270 /* TX PFD Config */
#define AD9361_REG_TX_INTEGER_BYTE_0                      0x271 /* TX Integer Byte 0 */
#define AD9361_REG_TX_INTEGER_BYTE_1                      0x272 /* TX Integer Byte 1 */
#define AD9361_REG_TX_FRACT_BYTE_0                        0x273 /* TX Fractional Byte 0 */
#define AD9361_REG_TX_FRACT_BYTE_1                        0x274 /* TX Fractional Byte 1 */
#define AD9361_REG_TX_FRACT_BYTE_2                        0x275 /* TX Fractional Byte 2 */
#define AD9361_REG_TX_FORCE_ALC                           0x276 /* TX Force ALC */
#define AD9361_REG_TX_FORCE_VCO_TUNE_0                    0x277 /* TX Force VCO Tune 0 */
#define AD9361_REG_TX_FORCE_VCO_TUNE_1                    0x278 /* TX Force VCO Tune 1 */
#define AD9361_REG_TX_ALCVARACT_OR                        0x279 /* TX ALC/Varact or */
#define AD9361_REG_TX_VCO_OUTPUT                          0x27A /* TX VCO Output */
#define AD9361_REG_TX_CP_CURRENT                          0x27B /* TX CP Current */
#define AD9361_REG_TX_CP_OFFSET                           0x27C /* TX CP Offset */
#define AD9361_REG_TX_CP_CONFIG                           0x27D /* TX CP Config */
#define AD9361_REG_TX_LOOP_FILTER_1                       0x27E /* TX Loop Filter 1 */
#define AD9361_REG_TX_LOOP_FILTER_2                       0x27F /* TX Loop Filter 2 */
#define AD9361_REG_TX_LOOP_FILTER_3                       0x280 /* TX Loop Filter 3 */
#define AD9361_REG_TX_DITHERCP_CAL                        0x281 /* TX Dither/CP Cal */
#define AD9361_REG_TX_VCO_BIAS_1                          0x282 /* TX VCO Bias 1 */
#define AD9361_REG_TX_VCO_BIAS_2                          0x283 /* TX VCO Bias 2 */
#define AD9361_REG_TX_CAL_STATUS                          0x284 /* TX Cal Status */
#define AD9361_REG_TX_VCO_CAL_REF                         0x285 /* TX VCO Cal Ref */
#define AD9361_REG_TX_VCO_PD_OVERRIDES                    0x286 /* TX VCO Pd Overrides */
#define AD9361_REG_TX_CP_OVERRANGE_VCO_LOCK               0x287 /* TX CP Over Range/VCO Lock */
#define AD9361_REG_TX_VCO_LDO                             0x288 /* TX VCO LDO */
#define AD9361_REG_TX_VCO_CAL                             0x289 /* TX VCO Cal */
#define AD9361_REG_TX_LOCK_DETECT_CONFIG                  0x28A /* TX Lock Detect Config */
#define AD9361_REG_TX_CP_LEVEL_DETECT                     0x28B /* TX CP Level Detect */
#define AD9361_REG_TX_DSM_SETUP_0                         0x28C /* TX DSM Setup 0 */
#define AD9361_REG_TX_DSM_SETUP_1                         0x28D /* TX DSM Setup 1 */
#define AD9361_REG_TX_CORRECTION_WORD0                    0x28E /* TX Correction Word0 */
#define AD9361_REG_TX_CORRECTION_WORD1                    0x28F /* TX Correction Word1 */
#define AD9361_REG_TX_VCO_VARACTOR_CTRL_0                 0x290 /* TX VCO Varactor Control 0 */
#define AD9361_REG_TX_VCO_VARACTOR_CTRL_1                 0x291 /* TX VCO Varactor Control 1 */
#define AD9361_REG_DCXO_COARSE_TUNE                       0x292 /* DCXO Coarse Tune */
#define AD9361_REG_DCXO_FINE_TUNE_HIGH                    0x293 /* DCXO Fine Tune2 */
#define AD9361_REG_DCXO_FINE_TUNE_LOW                     0x294 /* DCXO Fine Tune1 */
#define AD9361_REG_DCXO_CONFIG                            0x295 /* DCXO Config */
#define AD9361_REG_DCXO_TEMPCO_WRITE                      0x296 /* DCXO Tempco Write */
#define AD9361_REG_DCXO_TEMPCO_READ                       0x297 /* DCXO Tempco Read */
#define AD9361_REG_DCXO_TEMPCO_ADDR                       0x298 /* DCXO Tempco Addr */
#define AD9361_REG_DELTA_T_READ                           0x299 /* Delta T Read */
#define AD9361_REG_TX_FAST_LOCK_SETUP                     0x29A /* TX Fast Lock Setup */
#define AD9361_REG_TX_FAST_LOCK_SETUP_INIT_DELAY          0x29B /* TX Fast Lock Setup Init Delay */
#define AD9361_REG_TX_FAST_LOCK_PROGRAM_ADDR              0x29C /* TX Fast Lock Program Addr */
#define AD9361_REG_TX_FAST_LOCK_PROGRAM_DATA              0x29D /* TX Fast Lock Program Data */
#define AD9361_REG_TX_FAST_LOCK_PROGRAM_READ              0x29E /* TX Fast Lock Program Read */
#define AD9361_REG_TX_FAST_LOCK_PROGRAM_CTRL              0x29F /* TX Fast Lock Program Ctrl */
#define AD9361_REG_TX_LO_GEN_POWER_MODE                   0x2A1 /* TX LO Gen Power Mode */
#define AD9361_REG_BANDGAP_CONFIG0                        0x2A6 /* Bandgap Config0 */
#define AD9361_REG_BANDGAP_CONFIG1                        0x2A8 /* Bandgap Config1 */
#define AD9361_REG_REF_DIVIDE_CONFIG_1                    0x2AB /* Ref Divide Config 1 */
#define AD9361_REG_REF_DIVIDE_CONFIG_2                    0x2AC /* Ref Divide Config 2 */
#define AD9361_REG_GAIN_RX1                               0x2B0 /* Gain RX1 */
#define AD9361_REG_LPF_GAIN_RX1                           0x2B1 /* LPF Gain RX1 */
#define AD9361_REG_DIG_GAIN_RX1                           0x2B2 /* Dig gain RX1 */
#define AD9361_REG_FAST_ATTACK_STATE                      0x2B3 /* Fast Attack State */
#define AD9361_REG_SLOW_LOOP_STATE                        0x2B4 /* Slow Loop State */
#define AD9361_REG_GAIN_RX2                               0x2B5 /* Gain RX2 */
#define AD9361_REG_LPF_GAIN_RX2                           0x2B6 /* LPF Gain RX2 */
#define AD9361_REG_DIG_GAIN_RX2                           0x2B7 /* Dig Gain RX2 */
#define AD9361_REG_OVRG_SIGS_RX1                          0x2B8 /* Ovrg Sigs RX1 */
#define AD9361_REG_OVRG_SIGS_RX2                          0x2B9 /* Ovrg Sigs RX2 */
#define AD9361_REG_CTRL                                   0x3DF /* Control */
#define AD9361_REG_BIST_CONFIG                            0x3F4 /* BIST Config */
#define AD9361_REG_OBSERVE_CONFIG                         0x3F5 /* Observe Config */
#define AD9361_REG_BIST_AND_DATA_PORT_TEST_CONFIG         0x3F6 /* BIST and Data Port Test Config */
#define AD9361_REG_DAC_TEST_0                             0x3FC /* DAC Test 0 */
#define AD9361_REG_DAC_TEST_1                             0x3FD /* DAC Test 1 */
#define AD9361_REG_DAC_TEST_2                             0x3FE /* DAC Test 2 */
...
// AD9361_REG_MULTICHIP_SYNC_AND_TX_MON_CTRL
...
// AD9361_REG_TX_ENABLE_FILTER_CTRL
...
// AD9361_REG_RX_ENABLE_FILTER_CTRL
...
// AD9361_REG_START_TEMP_READING
#define START_TEMP_READING             BIT(0) /* Start Temp Reading */

// AD9361_REG_TEMP_SENSE2
...
// AD9361_REG_PARALLEL_PORT_CONF_2
...
// AD9361_REG_PARALLEL_PORT_CONF_3
...
// AD9361_REG_ENSM_MODE
#define FDD_MODE                       BIT(0) /* FDD Mode */

// AD9361_REG_ENSM_CONFIG_1
...
// AD9361_REG_RX_SYNTH_POWER_DOWN_OVERRIDE
...
// AD9361_REG_TX_SYNTH_POWER_DOWN_OVERRIDE
...
// AD9361_REG_RX_ANALOG_POWER_DOWN_OVERRIDE_1
...
// AD9361_REG_RX_ANALOG_POWER_DOWN_OVERRIDE_2
...
// AD9361_REG_TX_ANALOG_POWER_DOWN_OVERRIDE_1
...
// AD9361_REG_ANALOG_POWER_DOWN_OVERRIDE
...
// AD9361_REG_MISC_POWER_DOWN_OVERRIDE
...
// AD9361_REG_QUAD_CAL_STATUS_TX1
...
// AD9361_REG_QUAD_CAL_STATUS_TX2
...
// AD9361_REG_RX_FILTER_GAIN
#define FILTER_GAIN(x)                 (((x) & 0x3) << 0) /* Filter gain<1:0> */

// AD9361_REG_AGC_CONFIG_1
...
// AD9361_REG_SMALL_LMT_OVERLOAD_THRESH
...
// AD9361_REG_RX1_MANUAL_LPF_GAIN
...
// AD9361_REG_RX1_MANUAL_DIGITALFORCED_GAIN
...
// AD9361_REG_FAST_CONFIG_2_SETTLING_DELAY
...
// AD9361_REG_FAST_ENERGY_LOST_THRESH
...
// AD9361_REG_FAST_STRONGER_SIGNAL_THRESH
...
// AD9361_REG_FAST_LOW_POWER_THRESH
...
// AD9361_REG_FAST_ENERGY_DETECT_COUNT
...
// AD9361_REG_ADC_OVERLOAD_COUNTERS
...
// AD9361_REG_DIGITAL_SAT_COUNTER
...
// AD9361_REG_OUTER_POWER_THRESHS
...
// AD9361_REG_MEASURE_DURATION_23
...
// AD9361_REG_ADC_MEASURE_DURATION_01
...
// AD9361_REG_DEC_POWER_MEASURE_DURATION_0
...
// AD9361_REG_RX_QUAD_CAL_LEVEL
#define RX_QUAD_CAL_LEVEL(x)           (((x) & 0xF) << 0) /* RX Quad Cal Level <3 :0> */

// AD9361_REG_CALIBRATION_CONFIG_1
...
// AD9361_REG_RX2_INPUT_A_OFFSETS
...
// AD9361_REG_RX1_INPUT_BC_OFFSETS
...
// AD9361_REG_RX2_INPUT_BC_OFFSETS
...
// AD9361_REG_BB_DC_OFFSET_FAST_SETTLE_SHIFT
...
// AD9361_REG_RX_BBF_CC2_CTR
#define RX_BBF_CC2_CTR(x)              (((x) & 0x7F) << 0) /* RX BBF CC2 Ctr<6:0> */

// AD9361_REG_RX_BBF_POW_RZ_BYTE1
...
// AD9361_REG_RX_VCO_CAL_REF
#define VCO_CAL_REF_TCF(x)             (((x) & 0x7) << 0) /* VCO Cal Ref Tcf<2:0> */

// AD9361_REG_RX_VCO_PD_OVERRIDES
...
// AD9361_REG_RX_FAST_LOCK_PROGRAM_ADDR
...
// AD9361_REG_RX_FAST_LOCK_PROGRAM_CTRL
...
// AD9361_REG_TX_LOOP_FILTER_1
#define LOOP_FILTER_C2(x)              (((x) & 0xF) << 4) /* Loop Filter C2<3:0> */
#define LOOP_FILTER_C1(x)              (((x) & 0xF) << 0) /* Loop Filter C1<3:0> */

// AD9361_REG_TX_LOOP_FILTER_2
#define LOOP_FILTER_R1(x)              (((x) & 0xF) << 4) /* Loop Filter R1<3:0> */
#define LOOP_FILTER_C3(x)              (((x) & 0xF) << 0) /* Loop Filter C3<3:0> */

// AD9361_REG_TX_LOOP_FILTER_3
#define LOOP_FILTER_BYPASS_R3          BIT(7) /* Loop Filter Bypass R3 */
#define LOOP_FILTER_BYPASS_R1          BIT(6) /* Loop Filter Bypass R1 */
#define LOOP_FILTER_BYPASS_C2          BIT(5) /* Loop Filter Bypass C2 */
#define LOOP_FILTER_BYPASS_C1          BIT(4) /* Loop Filter Bypass C1 */
...
// AD9361_REG_TX_DSM_SETUP_0
#define DSM_PROG(x)                    (((x) & 0xF) << 0) /* DSM Prog<3:0> */

// AD9361_REG_TX_DSM_SETUP_1
#define SIF_CLOCK                      BIT(6) /* SIF clock */
#define SIF_RESET_BAR                  BIT(5) /* SIF Reset Bar */
#define SIF_ADDR(x)                    (((x) & 0x1F) << 0) /* SIF Addr<4:0> */

// AD9361_REG_TX_CORRECTION_WORD0
#define UPDATE_FREQ_WORD               BIT(7) /* Update Freq Word */
#define READ_EFFECTIVE_TUNING_WORD     BIT(5) /* Read Effective Tuning Word */
#define FREQ_CORRECTION_WORD_MSB(x)    (((x) & 0x1F) << 0) /* Frequency Correction Word<11:7> */

// AD9361_REG_TX_CORRECTION_WORD1
#define UPDATE_FREQ_WORD               BIT(7) /* Update Freq Word */
#define FREQ_CORRECTION_WORD_LSB(x)    (((x) & 0x7F) << 0) /* Frequency Correction Word<6:0> */

// AD9361_REG_TX_VCO_VARACTOR_CTRL_0
#define VCO_VARACTOR_REFERENCE_TCF(x)  (((x) & 0x7) << 4) /* VCO Varactor Reference Tcf<2:0> */
#define VCO_VARACTOR_OFFSET(x)         (((x) & 0xF) << 0) /* VCO Varactor Offset<3:0> */

// AD9361_REG_TX_VCO_VARACTOR_CTRL_1
#define VCO_VARACTOR_REFERENCE(x)      (((x) & 0xF) << 0) /* VCO Varactor Reference<3:0> */

// AD9361_REG_DCXO_COARSE_TUNE
#define DCXO_TUNE_COARSE(x)            (((x) & 0x3F) << 0) /* DCXO Tune Coarse<5:0> */

// AD9361_REG_DCXO_FINE_TUNE_LOW
#define DCXO_TUNE_FINE_LOW(x)          (((x) & 0x1F) << 3) /* DCXO Tune Fine<4:0> */

// AD9361_REG_DCXO_FINE_TUNE_HIGH
#define DCXO_TUNE_FINE_HIGH(x)         ((x) >> 5) /* DCXO Tune Fine<12:5> */

// AD9361_REG_DCXO_CONFIG
#define MUST_BE_ZERO                   BIT(7) /* Must be zero */
#define DCXO_RTAIL(x)                  (((x) & 0x7) << 4) /* DCXO Rtail<2:0> */
#define DCXO_RD(x)                     (((x) & 0x3) << 2) /* DCXO Rd<1:0> */

// AD9361_REG_DCXO_TEMPCO_ADDR
...
// AD9361_REG_TX_FAST_LOCK_PROGRAM_CTRL
...
// AD9361_REG_TX_LO_GEN_POWER_MODE
#define TX_LO_GEN_POWER_MODE(x)        (((x) & 0xF) << 4) /* Power Mode<3:0> */

// AD9361_REG_BANDGAP_CONFIG0
...
// AD9361_REG_REF_DIVIDE_CONFIG_1
...
// AD9361_REG_REF_DIVIDE_CONFIG_2
...
// AD9361_REG_BIST_AND_DATA_PORT_TEST_CONFIG
...
public:
    ...
    struct BISTConfig
    {
        ...
        enum InjectionPoint
        {
            INJ_TX = 0, // Samples will be transmitted
            INJ_RX = 2, // Samples will come out of the digital port towards the FPGA
        };
        enum Mask
        {
            MASK_NONE = 0,
        ...
        bool enable;
        AD9361::BISTConfig::Mode mode = AD9361::BISTConfig::PRBS;
        AD9361::BISTConfig::InjectionPoint injection_point = AD9361::BISTConfig::INJ_RX;
        AD9361::BISTConfig::Mask mask = AD9361::BISTConfig::MASK_NONE;
        AD9361::BISTConfig::ToneFrequency tone_freq = AD9361::BISTConfig::CLK_DIV_32;
        AD9361::BISTConfig::ToneLevel tone_level = AD9361::BISTConfig::FS;
    };
...
public:
    AD9361(AD9361::SPIConfig spi, AD9361::GPIOConfig reset_gpio = {nullptr, 0, false}, AD9361::GPIOConfig sync_gpio = {nullptr, 0, false});
    ~AD9361();
    ...
    void setBISTConfig(AD9361::BISTConfig cfg);
    AD9361::BISTConfig getBISTConfig();

    void setTXInterfaceDelay(AD9361::InterfaceDelay delay);
    AD9361::InterfaceDelay getTXInterfaceDelay();
    void setRXInterfaceDelay(AD9361::InterfaceDelay delay);
    AD9361::InterfaceDelay getRXInterfaceDelay();
    ...
    void enableParallelPortLoopback(bool enable = true);
    inline void disableParallelPortLoopback()
    {
        this->enableParallelPortLoopback(false);
    }
    bool isParallelPortLoopbackEnabled();
    ...
    void setChannelCount(uint8_t ch_no);
    inline uint8_t getChannelCount()
    {
        return this->pdata->rx2tx2 ? 2 : 1;
    }
    ...
    {
        this->writeReg(AD9361_REG_CALIBRATION_CTRL, mask);
        this->checkCalibrationDone(AD9361_REG_CALIBRATION_CTRL, mask, 0, timeout_ms);
    }
    void checkCalibrationDone(uint16_t reg, uint8_t mask, uint8_t done_val, uint32_t timeout_ms = 5000);
    ...
    {
        if(mode == DISABLE)
            return this->writeRegField(AD9361_REG_BBPLL, CLKOUT_ENABLE, 0);

        return this->writeRegField(AD9361_REG_BBPLL, CLKOUT_ENABLE | CLKOUT_SELECT(~0), ((mode - 1) << 1) | 0x1);
    }
    ...
    void enableTX(uint8_t mask, uint8_t en)
    {
        ...
        return this->writeRegField(AD9361_REG_TX_ENABLE_FILTER_CTRL, TX_CHANNEL_ENABLE(mask), en);
    }
    void enableRX(uint8_t mask, uint8_t en)
    {
        ...
        return this->writeRegField(AD9361_REG_RX_ENABLE_FILTER_CTRL, RX_CHANNEL_ENABLE(mask), en);
    }
...
private:
    ...
    std::recursive_mutex auxdac_mutex;

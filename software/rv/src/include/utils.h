...
#define IROM0_TEXT __attribute__ ((section(".irom0.text")))
...
#define FLASH_CODE IROM0_TEXT
#define ROM_DATA   DROM0_DATA
#define BRAM_CODE  IRAM0_TEXT
#define BRAM_DATA  DRAM0_DATA
#define DDR3_CODE  IRAM1_TEXT
#define DDR3_DATA  DRAM1_DATA

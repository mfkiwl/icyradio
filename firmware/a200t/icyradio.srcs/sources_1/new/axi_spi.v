...
always @(posedge aclk)
    begin
        if(!spi_en)
            ...
            begin
                spi_io_i <= {2'b00, spi_io1_i, spi_io0_i};
                ...
                if(s_axi_rd_en)
                    begin
                        ...
                        case(s_axi_araddr[S_AXI_ASZ - 1:S_AXI_ADDR_LSB])
                            ...
                            4'h1:    s_axi_rdata <= {1'd0, spi_io_mode_q, 4'd0, spi_fsm_state, spi_dir, spi_idle, 2'd0, spi_sr_in_buf_valid, spi_sr_out_buf_valid, 7'd0, spi_lsb_first, 1'd0, spi_io_mode, spi_mode, spi_en, spi_sck_div_en};
                            ...
                            4'h4:    s_axi_rdata <= {{(S_AXI_DSZ - SCK_DIV_SZ){1'b0}}, spi_sck_div};
